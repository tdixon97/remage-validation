...
def run_reboost(generator_name,name,val,reboost_config="hit_config.yaml"):
    ...
    build_glm(glm_files = f"{glm_directory}/out.lh5",stp_files = f"{stp_directory}/out.lh5",id_name = "evtid")
...
for generator in generators:
    ...
    for step_limits in np.linspace(10,190,7):
        ...
        profile[generator]["step_limits"][str(step_limits)] = {"time":f"{times:.3f}","size":size}
    """
